...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
            (!this._options.disableDefaultDropzone ? '<div style="display:none" class="qq-upload-drop-area"><span>{dragText}</span></div>' : '') +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
        ...
        item.qqFileId = id;
		item.fileName = fileName;//add by damon
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    getName: function(id){
        // get input value and remove path to normalize
		// modify by damon 2013-09-10
		var fullPath=this._inputs[id].value.replace(/.*(\/|\\)/, "");
		try {
...
qq.extend(qq.UploadHandlerXhr.prototype, {
    ...
    getName: function(id){
		...
		var name = (file.fileName !== null && file.fileName !== undefined) ? file.fileName : file.name;
		try {
