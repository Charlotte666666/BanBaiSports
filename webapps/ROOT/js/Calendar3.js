...
Calendar.prototype.show = function (dateControl, popuControl) {
    // modify by HuangYongLiu 2015-01-04
    if ( top.isUseFullDateSelecter() ) {
		top.selectDate(dateControl);
	    return ;
	}
	/////// end of modify
	...
	//this.panel.style.left ="38%";
	//this.panel.style.top = "26%";
...
Calendar.prototype.hide = function() {
	this.panel.style.visibility = "hidden";
	try{
	  onDateSelectChanged(this.dateControl);
	}catch(e){}
};
