...
//out.println("数据库总连接数: " + cn.gov.cdc.dao.ConnectionPool.pool.getTotalCreatedConnections() + "<br/>");
//out.println("数据库使用连接数: " + cn.gov.cdc.dao.ConnectionPool.pool.getTotalLeased() + "<br/>");
//out.println("数据库空闲连接数: " + cn.gov.cdc.dao.ConnectionPool.pool.getTotalFree() + "<br/>");
