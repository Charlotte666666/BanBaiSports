...
<%@ page import="com.helpyouworkeasy.service.OrderService"%>
<%
	//获取支付宝POST过来反馈信息
	...
	if(AlipayNotify.verify(params)){//验证成功
		...
		//判断是否在商户网站中已经做过了这次通知返回的处理
			...
			System.out.println("return pay success,batch_no="+batch_no+" success_num="+success_num+" result_details="+result_details);
			WebApplicationContext wac=WebApplicationContextUtils.getWebApplicationContext(this.getServletContext());
			OrderService service = wac.getBean(OrderService.class);
			if ( success_num.equals("1") ) {
				service.updateRefunStatus(batch_no,"1");
			}
