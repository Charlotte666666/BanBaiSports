package {
dynamic class $lzc$class__ml7 extends LzText {
/* -*- file: flowDesigner/FlowStateNode.lzx#144 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mkx ($0) {
/* -*- file: #143 -*- */
var $1 = parent.width;
/* -*- file: -*- */
...
/* -*- file: flowDesigner/FlowStateNode.lzx#143 -*- */
function $mky () {
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowStateNode.lzx#146 -*- */
return [parent, "width"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
