package {
dynamic class $lzc$class__mi6 extends LzText {
/* -*- file: common/components/EditCombobox.lzx#36 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mhu ($0) {
/* -*- file: #35 -*- */
var $1 = parent.labelWidth;
/* -*- file: -*- */
if ($1 !== this["width"] || !this.inited) {
this.setAttribute("width", $1)
}}
/* -*- file: common/components/EditCombobox.lzx#35 -*- */
function $mhv () {
/* -*- file: -*- */
try {
/* -*- file: common/components/EditCombobox.lzx#38 -*- */
return [parent, "labelWidth"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
if ($lzsc$e is Error) {
...
function $mhw ($0) {
/* -*- file: #35 -*- */
var $1 = parent.labelText + (parent.isRequire ? '<font color="#FF0000" >(*)</font>:' : ":");
/* -*- file: -*- */
...
try {
/* -*- file: common/components/EditCombobox.lzx#38 -*- */
return [parent, "labelText", parent, "isRequire"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
if ($lzsc$e is Error) {
