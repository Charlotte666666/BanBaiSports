package {
dynamic class $lzc$class__mh7 extends LzText {
/* -*- file: common/components/EditText.lzx#73 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mge ($0) {
/* -*- file: #72 -*- */
...
/* -*- file: common/components/EditText.lzx#72 -*- */
function $mgf () {
/* -*- file: -*- */
try {
