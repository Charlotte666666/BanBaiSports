package {
dynamic class $lzc$class__m8q extends LzView {
/* -*- file: base/basecombobox.lzx#120 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $m7f ($0) {
/* -*- file: #119 -*- */
...
/* -*- file: base/basecombobox.lzx#119 -*- */
function $m7g () {
/* -*- file: -*- */
try {
/* -*- file: base/basecombobox.lzx#122 -*- */
