package {
dynamic class $lzc$class__mqt extends LzInputText {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#639 -*- */
static var displayName = "<anonymous extends='inputtext'>";static var attributes = new LzInheritedHash(LzInputText.attributes);function $mos ($0) {
/* -*- file: #638 -*- */
...
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#638 -*- */
function $mot () {
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#641 -*- */
