package {
dynamic class $lzc$class__mja extends LzText {
/* -*- file: common/components/EditCombobox.lzx#105 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $min ($0) {
/* -*- file: #104 -*- */
