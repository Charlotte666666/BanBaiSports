package {
dynamic class $lzc$class__mhp extends LzText {
/* -*- file: common/components/PageNumBar.lzx#78 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mhb ($0) {
/* -*- file: #77 -*- */
var $1 = parent.width - 75;
/* -*- file: -*- */
if ($1 !== this["width"] || !this.inited) {
this.setAttribute("width", $1)
}}
/* -*- file: common/components/PageNumBar.lzx#77 -*- */
function $mhc () {
/* -*- file: -*- */
try {
