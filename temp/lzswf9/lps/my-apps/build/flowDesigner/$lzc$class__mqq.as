package {
dynamic class $lzc$class__mqq extends LzInputText {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#627 -*- */
static var displayName = "<anonymous extends='inputtext'>";static var attributes = new LzInheritedHash(LzInputText.attributes);function $mog ($0) {
/* -*- file: #626 -*- */
...
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#626 -*- */
function $moh () {
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#629 -*- */
