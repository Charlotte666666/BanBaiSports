package {
dynamic class $lzc$class__m35 extends LzView {
/* -*- file: lz/button.lzx#159 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $m2d ($0) {
/* -*- file: #158 -*- */
...
var $classrootdepth;function $lzc$class__m35 ($0:LzNode? = null, $1:Object? = null, $2:Array? = null, $3:Boolean = false) {
super($0, $1, $2, $3)
}
