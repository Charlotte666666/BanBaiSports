package {
dynamic class $lzc$class__mlu extends LzText {
/* -*- file: flowDesigner/FlowNode.lzx#126 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mlk ($0) {
/* -*- file: #125 -*- */
...
/* -*- file: flowDesigner/FlowNode.lzx#125 -*- */
function $mll () {
/* -*- file: -*- */
try {
