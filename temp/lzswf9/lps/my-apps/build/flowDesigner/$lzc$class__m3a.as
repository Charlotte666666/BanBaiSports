package {
dynamic class $lzc$class__m3a extends LzText {
/* -*- file: lz/button.lzx#176 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $m2x ($0) {
/* -*- file: #175 -*- */
var $1 = parent.text_x + parent.titleshift;
/* -*- file: -*- */
if ($1 !== this["x"] || !this.inited) {
this.setAttribute("x", $1)
}}
/* -*- file: lz/button.lzx#175 -*- */
function $m2y () {
/* -*- file: -*- */
try {
/* -*- file: lz/button.lzx#178 -*- */
...
function $m2z ($0) {
/* -*- file: #175 -*- */
var $1 = parent.text_y + parent.titleshift;
/* -*- file: -*- */
