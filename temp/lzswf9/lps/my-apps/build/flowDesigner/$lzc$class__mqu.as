package {
dynamic class $lzc$class__mqu extends LzInputText {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#645 -*- */
static var displayName = "<anonymous extends='inputtext'>";static var attributes = new LzInheritedHash(LzInputText.attributes);function $mov ($0) {
/* -*- file: #644 -*- */
...
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#644 -*- */
function $mow () {
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowDesignerSingle.lzx#647 -*- */
