package {
dynamic class $lzc$class__m39 extends LzView {
/* -*- file: lz/button.lzx#168 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $m2t ($0) {
/* -*- file: #167 -*- */
var $1 = parent.parent.height - 1;
/* -*- file: -*- */
if ($1 !== this["y"] || !this.inited) {
this.setAttribute("y", $1)
}}
/* -*- file: lz/button.lzx#167 -*- */
function $m2u () {
/* -*- file: -*- */
try {
/* -*- file: lz/button.lzx#170 -*- */
