package {
dynamic class $lzc$class__mkf extends LzText {
/* -*- file: common/components/RadioGroup.lzx#67 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mk9 ($0) {
/* -*- file: #66 -*- */
...
/* -*- file: -*- */
try {
/* -*- file: common/components/RadioGroup.lzx#69 -*- */
