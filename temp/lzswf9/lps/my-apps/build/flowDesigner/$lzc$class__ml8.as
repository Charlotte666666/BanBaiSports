package {
dynamic class $lzc$class__ml8 extends LzView {
/* -*- file: flowDesigner/FlowStateNode.lzx#145 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $ml1 ($0) {
/* -*- file: #144 -*- */
...
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowStateNode.lzx#147 -*- */
return [parent, "width"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
