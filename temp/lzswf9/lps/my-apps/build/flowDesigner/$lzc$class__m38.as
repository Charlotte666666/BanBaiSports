package {
dynamic class $lzc$class__m38 extends LzView {
/* -*- file: lz/button.lzx#167 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $m2p ($0) {
/* -*- file: #166 -*- */
...
/* -*- file: lz/button.lzx#166 -*- */
function $m2q () {
/* -*- file: -*- */
try {
/* -*- file: lz/button.lzx#169 -*- */
