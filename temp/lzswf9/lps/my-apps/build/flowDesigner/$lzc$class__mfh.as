package {
dynamic class $lzc$class__mfh extends LzView {
/* -*- file: lz/window.lzx#44 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $mew ($0) {
/* -*- file: #43 -*- */
