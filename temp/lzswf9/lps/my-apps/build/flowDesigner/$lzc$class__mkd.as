package {
dynamic class $lzc$class__mkd extends LzText {
/* -*- file: common/components/RadioGroup.lzx#64 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mk1 ($0) {
/* -*- file: #63 -*- */
...
/* -*- file: common/components/RadioGroup.lzx#63 -*- */
function $mk2 () {
/* -*- file: -*- */
try {
/* -*- file: common/components/RadioGroup.lzx#66 -*- */
