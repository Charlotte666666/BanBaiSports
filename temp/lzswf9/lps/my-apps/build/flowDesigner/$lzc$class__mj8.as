package {
dynamic class $lzc$class__mj8 extends LzView {
/* -*- file: common/components/EditCombobox.lzx#101 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $mii ($0) {
/* -*- file: #100 -*- */
...
/* -*- file: -*- */
try {
/* -*- file: common/components/EditCombobox.lzx#103 -*- */
