package {
dynamic class $lzc$class__m33 extends LzView {
/* -*- file: lz/button.lzx#155 -*- */
static var displayName = "<anonymous extends='view'>";static var attributes = new LzInheritedHash(LzView.attributes);function $m25 ($0) {
/* -*- file: #154 -*- */
var $1 = parent.width - 1;
/* -*- file: -*- */
if ($1 !== this["width"] || !this.inited) {
this.setAttribute("width", $1)
}}
/* -*- file: lz/button.lzx#154 -*- */
function $m26 () {
/* -*- file: -*- */
try {
/* -*- file: lz/button.lzx#157 -*- */
return [parent, "width"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
...
var $classrootdepth;function $lzc$class__m33 ($0:LzNode? = null, $1:Object? = null, $2:Array? = null, $3:Boolean = false) {
super($0, $1, $2, $3)
}
