...
static var tagname = "DrawTool";static var children = LzNode.mergeChildren([], $lzc$class_drawview["children"]);static var attributes = new LzInheritedHash($lzc$class_drawview.attributes);function $mkh ($0) {
/* -*- file: #5 -*- */
