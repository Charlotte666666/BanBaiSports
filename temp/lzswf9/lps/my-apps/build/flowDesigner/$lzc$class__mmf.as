package {
dynamic class $lzc$class__mmf extends LzText {
/* -*- file: flowDesigner/FlowLine.lzx#627 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $mm8 ($0) {
/* -*- file: #626 -*- */
var $1 = parent.text;
/* -*- file: -*- */
...
/* -*- file: flowDesigner/FlowLine.lzx#626 -*- */
function $mm9 () {
/* -*- file: -*- */
try {
/* -*- file: flowDesigner/FlowLine.lzx#629 -*- */
return [parent, "text"]
}
/* -*- file: -*- */
catch ($lzsc$e) {
