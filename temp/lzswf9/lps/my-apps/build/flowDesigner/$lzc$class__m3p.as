package {
dynamic class $lzc$class__m3p extends LzText {
/* -*- file: lz/checkbox.lzx#23 -*- */
static var displayName = "<anonymous extends='text'>";static var attributes = new LzInheritedHash(LzText.attributes);function $m3f ($0) {
/* -*- file: #22 -*- */
var $1 = classroot.text_y;
/* -*- file: -*- */
if ($1 !== this["y"] || !this.inited) {
this.setAttribute("y", $1)
}}
/* -*- file: lz/checkbox.lzx#22 -*- */
function $m3g () {
/* -*- file: -*- */
try {
/* -*- file: lz/checkbox.lzx#25 -*- */
