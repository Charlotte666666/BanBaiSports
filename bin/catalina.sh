...
if [ -z "$LOGGING_MANAGER" ]; then
  JAVA_OPTS="$JAVA_OPTS -Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager -server -XX:-UseGCOverheadLimit"
else
  JAVA_OPTS="$JAVA_OPTS $LOGGING_MANAGER -server  -XX:-UseGCOverheadLimit"
fi
